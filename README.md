...
- **`01_clean_bnee.py`**: Script para limpiar y preprocesar los datos del Balance Nacional de Energía Eléctrica (BNEE).
- **`02_clean_facturacion.py`**: Script para limpiar y procesar los datos de facturación de energía de CNEL - Guayaquil.
- **`03_modelo_forecasting.py`**: Script para entrenar el modelo y generar las predicciones.
- **`04_interfaz_prediccion.py`**: Interfaz de usuario para ingresar un mes/año y obtener una predicción de consumo de energía.
